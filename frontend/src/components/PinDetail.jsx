...
const PinDetail = ({user}) => {
  ...
  return (
    ...
    <div className='flex xl-flex-row flex-col m-auto bg-white'style={{maxWidth:'1500px',borderRadius:'32px'}}>
      <div className='flex justify-center items-center md:items-start felx-initial'>
      ...
      <div className='w-full p-5 flex-1 xl:min-w-620'>
        ...
        <img className='w-8 h-8 rounded-full object-cover' src={pinDetail.postedBy?.image}/>
       ...
       <div className='flex felx-wrap mt-6 gap-3'>
       <Link to={`user-profile/${pinDetail.postedBy?._id}`} >
        <img className='w-10 h-10 rounded-full cursor-pointer' src={pinDetail.postedBy?.image}/>
       </Link>
